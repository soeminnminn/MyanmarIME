...
import com.androidtweak.inputmethod.myanmar.XmlParseUtils;
import com.androidtweak.inputmethod.keyboard.internal.KeyStyles;
import com.androidtweak.inputmethod.keyboard.internal.KeyboardCodesSet;
import com.androidtweak.inputmethod.keyboard.internal.KeyboardIconsSet;
import com.androidtweak.inputmethod.keyboard.internal.KeyboardTextsSet;
...
public class Keyboard {
    ...
    public final boolean mShiftCapEnable; // SMM
    ...
    public Keyboard(Params params) {
        ...
        // SMM {
        mShiftCapEnable = params.mShiftCapEnable;
        // } SMM
    }
    ...
    public static class Params {
        ...
        public String mFontName = "default";
    ...
    public static class Builder<KP extends Params> {
        ...
        private void parseKeyboardAttributes(XmlPullParser parser) {
            ...
            try {
                ...
                params.mShiftCapEnable = keyboardAttr.getBoolean(R.styleable.Keyboard_shiftCapEnable, true); // SMM
        ...
        private void parseKeyboardContent(XmlPullParser parser, boolean skip)
            ...
            while ((event = parser.next()) != XmlPullParser.END_DOCUMENT) {
                if (event == XmlPullParser.START_TAG) {
                    ...
                    } else if (TAG_TEXT_FONT.equals(tag)) {
                    	parseTextFont(parser);
        ...
        // SMM {
        private void parseTextFont(XmlPullParser parser) 
        		throws XmlPullParserException, IOException {
        	final TypedArray a = mResources.obtainAttributes(Xml.asAttributeSet(parser),
                    R.styleable.Keyboard_TextFont);
        	try {
        		final String fontName = a.getString(R.styleable.Keyboard_TextFont_fontName);
            	mParams.mFontName = fontName == null ? "default" : fontName;
        		mParams.mSizeAdjust = a.getFloat(R.styleable.Keyboard_TextFont_sizeAdjust, 1.0f);
        		mParams.mDrawFixCode = a.getInt(R.styleable.Keyboard_TextFont_drawFixCode, 0x0);
        		mParams.mAppendDeadKey = a.getBoolean(R.styleable.Keyboard_TextFont_appendDeadKey, false);
            } finally {
                a.recycle();
            }
        	XmlParseUtils.checkEndTag(TAG_TEXT_FONT, parser);
        }
        // } SMM
