...
import com.androidtweak.inputmethod.myanmar.VibratorUtils;
import com.androidtweak.inputmethod.keyboard.Keyboard;

/**
 * This class gathers audio feedback and haptic feedback functions.
 *
 * It offers a consistent and simple interface that allows MyanmarIME to forget about the
...
public class AudioAndHapticFeedbackManager {
    ...
    public AudioAndHapticFeedbackManager(final MyanmarIME myanmarIme,
            final SettingsValues settingsValues) {
        mSettingsValues = settingsValues;
        mVibratorUtils = VibratorUtils.getInstance(myanmarIme);
        mAudioManager = (AudioManager) myanmarIme.getSystemService(Context.AUDIO_SERVICE);
    ...
    // TODO: make this private when MyanmarIME does not call it any more
