...
import static com.androidtweak.inputmethod.myanmar.Constants.ImeOption.FORCE_ASCII;
import static com.androidtweak.inputmethod.myanmar.Constants.ImeOption.NO_MICROPHONE;
import static com.androidtweak.inputmethod.myanmar.Constants.ImeOption.NO_MICROPHONE_COMPAT;
...
import com.androidtweak.inputmethod.accessibility.AccessibilityUtils;
import com.androidtweak.inputmethod.accessibility.AccessibleKeyboardViewProxy;
import com.androidtweak.inputmethod.compat.CompatUtils;
import com.androidtweak.inputmethod.compat.InputMethodManagerCompatWrapper;
import com.androidtweak.inputmethod.compat.SuggestionSpanUtils;
import com.androidtweak.inputmethod.myanmar.LocaleUtils.RunInLocale;
import com.androidtweak.inputmethod.myanmar.define.ProductionFlag;
import com.androidtweak.inputmethod.myanmar.suggestions.SuggestionsView;

import com.androidtweak.inputmethod.myanmar.R;
import com.androidtweak.inputmethod.keyboard.Keyboard;
import com.androidtweak.inputmethod.keyboard.KeyboardActionListener;
import com.androidtweak.inputmethod.keyboard.KeyboardId;
import com.androidtweak.inputmethod.keyboard.KeyboardSwitcher;
import com.androidtweak.inputmethod.keyboard.KeyboardView;
import com.androidtweak.inputmethod.keyboard.SoftKeyboardView;
 ...
 */
public class MyanmarIME extends InputMethodService implements KeyboardActionListener,
        SuggestionsView.Listener, TargetApplicationGetter.OnTargetApplicationKnownListener {
    private static final String TAG = MyanmarIME.class.getSimpleName();
    ...
    // Double space: the state where the user pressed space twice quickly, which MyanmarIME
    ...
    public static class UIHandler extends StaticInnerHandlerWrapper<MyanmarIME> {
        ...
        public UIHandler(MyanmarIME outerInstance) {
            super(outerInstance);
        }
        ...
        public void handleMessage(Message msg) {
            final MyanmarIME myanmarIme = getOuterInstance();
            final KeyboardSwitcher switcher = myanmarIme.mKeyboardSwitcher;
            switch (msg.what) {
            case MSG_UPDATE_SUGGESTIONS:
                myanmarIme.updateSuggestions();
                break;
            case MSG_UPDATE_SHIFT_STATE:
                switcher.updateShiftState();
                break;
            case MSG_SET_BIGRAM_PREDICTIONS:
                myanmarIme.updateBigramPredictions();
                break;
            }
        }
        ...
        public void startOrientationChanging() {
            ...
            final MyanmarIME myanmarIme = getOuterInstance();
            if (myanmarIme.isInputViewShown()) {
                myanmarIme.mKeyboardSwitcher.saveKeyboardState();
            }
        }
        ...
        private void executePendingImsCallback(MyanmarIME myanmarIme, EditorInfo editorInfo,
                boolean restarting) {
            if (mHasPendingFinishInputView)
                myanmarIme.onFinishInputViewInternal(mHasPendingFinishInput);
            if (mHasPendingFinishInput)
                myanmarIme.onFinishInputInternal();
            if (mHasPendingStartInput)
                myanmarIme.onStartInputInternal(editorInfo, restarting);
            resetPendingImsCallback();
        }
        ...
        public void onStartInput(EditorInfo editorInfo, boolean restarting) {
            if (hasMessages(MSG_PENDING_IMS_CALLBACK)) {
                ...
                final MyanmarIME myanmarIme = getOuterInstance();
                executePendingImsCallback(myanmarIme, editorInfo, restarting);
                myanmarIme.onStartInputInternal(editorInfo, restarting);
            }
        }
        ...
        public void onStartInputView(EditorInfo editorInfo, boolean restarting) {
            if (hasMessages(MSG_PENDING_IMS_CALLBACK)
                ...
                final MyanmarIME myanmarIme = getOuterInstance();
                executePendingImsCallback(myanmarIme, editorInfo, restarting);
                myanmarIme.onStartInputViewInternal(editorInfo, restarting);
        ...
        public void onFinishInputView(boolean finishingInput) {
            if (hasMessages(MSG_PENDING_IMS_CALLBACK)) {
                ...
                final MyanmarIME myanmarIme = getOuterInstance();
                myanmarIme.onFinishInputViewInternal(finishingInput);
        ...
        public void onFinishInput() {
            if (hasMessages(MSG_PENDING_IMS_CALLBACK)) {
                ...
                final MyanmarIME myanmarIme = getOuterInstance();
                executePendingImsCallback(myanmarIme, null, false);
                myanmarIme.onFinishInputInternal();
            }
        }
    }
    ...
    public void onCreate() {
        ...
        mPrefs = prefs;
        MyanmarImeLogger.init(this, prefs);
    ...
    /* package */ void loadSettings() {
        ...
        final RunInLocale<SettingsValues> job = new RunInLocale<SettingsValues>() {
            ...
            protected SettingsValues job(Resources res) {
                return new SettingsValues(mPrefs, MyanmarIME.this);
            }
        };
    ...
    public void onDestroy() {
        ...
        MyanmarImeLogger.commit();
        MyanmarImeLogger.onDestroy();
        super.onDestroy();
    }
    ...
    public void setInputView(View view) {
        ...
        if (MyanmarImeLogger.sVISUALDEBUG) {
    ...
    private void onStartInputViewInternal(EditorInfo editorInfo, boolean restarting) {
        ...
        SoftKeyboardView inputView = switcher.getKeyboardView();
        ...
        if (ProductionFlag.IS_EXPERIMENTAL) {
            ResearchLogger.ime_onStartInputViewInternal(editorInfo, mPrefs);
        }
        ...
        MyanmarImeLogger.onStartInputView(editorInfo);
        ...
        mWordComposer.setLocale(getCurrentLocale()); // SMM
    ...
    public void onUpdateSelection(int oldSelStart, int oldSelEnd,
        ...
        if (ProductionFlag.IS_EXPERIMENTAL) {
            ResearchLogger.ime_onUpdateSelection(mLastSelectionStart, mLastSelectionEnd,
        ...
        if (!mExpectingUpdateSelection) {
            ...
            // state-related special processing to kick com.
            mSpaceState = SPACE_STATE_NONE;
    ...
    public void onDisplayCompletions(CompletionInfo[] applicationSpecifiedCompletions) {
        ...
        if (ProductionFlag.IS_EXPERIMENTAL) {
            ResearchLogger.ime_onDisplayCompletions(applicationSpecifiedCompletions);
        }
    ...
    private void setSuggestionStripShownInternal(boolean shown, boolean needsInputViewShown) {
        ...
        if (onEvaluateInputViewShown() && mSuggestionsContainer != null) {
            final SoftKeyboardView keyboardView = mKeyboardSwitcher.getKeyboardView();
    ...
    // SMM {
    public CharSequence getWordCorrection(CharSequence text) {
    	String output = text.toString();
    	final InputMethodSubtype subtype = mKeyboardSwitcher.getCurrentSubType();
    	if (subtype == null) return output;
    	final Locale locale = SubtypeLocale.getSubtypeLocale(subtype);
    	if(locale == null) return output;
    	if (locale.getLanguage().equals("my")) {
    		if (locale.getCountry().equals("ZG")) {
    	    	if(mSettingsValues.mAutoCorrectEnabled) {
    		    	output = MyanmarImeUtils.getZawgyiWord(text).toString();
    	    	}
    	    	if(mSettingsValues.mUsedUnicode) {
    	    		return MyanmarImeUtils.getZawGyiToUni(output);
    	    	}
    	    	if(mSettingsValues.mJellyBeanFix) {
    	    		return MyanmarImeUtils.getJellyBeanFix(output);
    	    	}
    		}
    	}
    	return output;
    ...
    public Locale getCurrentLocale() {
    	final Locale defaultLocale = mResources.getConfiguration().locale;
    	final InputMethodSubtype subtype = mKeyboardSwitcher.getCurrentSubType();
    	if (subtype == null) return defaultLocale;
    	final Locale locale = SubtypeLocale.getSubtypeLocale(subtype);
    ...
    public void commitTyped(final InputConnection ic, final int separatorCode) {
        ...
        if(mWordComposer.getUsedFixedWord()) {
        	typedWord = mWordComposer.getFixedWord();
        } // } SMM
        if (typedWord.length() > 0) {
            if (ic != null) {
            	ic.commitText(typedWord, 1);
                if (ProductionFlag.IS_EXPERIMENTAL) {
                    ResearchLogger.ime_commitText(typedWord);
                }
            }
    ...
    public int getCurrentAutoCapsState() {
        ...
        if (!isAutoCapsEnabledLocale()) return Constants.TextUtils.CAP_MODE_OFF; // SMM
    ...
    private void swapSwapperAndSpaceWhileInBatchEdit(final InputConnection ic) {
        if (null == ic) return;
        if(!isSpaceFollowedLocale()) return; // SMM
        ...
        if (lastTwo != null && lastTwo.length() == 2
            ...
            if (ProductionFlag.IS_EXPERIMENTAL) {
                ResearchLogger.ime_deleteSurroundingText(2);
            }
            ic.commitText(lastTwo.charAt(1) + " ", 1);
            if (ProductionFlag.IS_EXPERIMENTAL) {
                ResearchLogger.ime_swapSwapperAndSpaceWhileInBatchEdit();
            }
    ...
    private boolean maybeDoubleSpaceWhileInBatchEdit(final InputConnection ic) {
        ...
        if (lastThree != null && lastThree.length() == 3
            ...
            ic.commitText(". ", 1);
            if (ProductionFlag.IS_EXPERIMENTAL) {
                ResearchLogger.ime_doubleSpaceAutoPeriod();
            }
            mKeyboardSwitcher.updateShiftState();
            return true;
        }
    ...
    private boolean canBeFollowedByPeriod(final int codePoint) {
    ...
    private void removeTrailingSpaceWhileInBatchEdit(final InputConnection ic) {
        ...
        if (lastOne != null && lastOne.length() == 1
            ...
            if (ProductionFlag.IS_EXPERIMENTAL) {
                ResearchLogger.ime_deleteSurroundingText(1);
            }
        }
    }
    ...
    private static boolean isAlphabet(int code) {
    	// SMM {
    	if(MyanmarImeUtils.isMyChar(code)) {
    		return MyanmarImeUtils.isAlphabet(code);
    	}
    	// } SMM
    ...
    private void performEditorAction(int actionId) {
        ...
        if (ic != null) {
            ...
            if (ProductionFlag.IS_EXPERIMENTAL) {
                ResearchLogger.ime_performEditorAction(actionId);
            }
        }
    }
    ...
    private void sendKeyCodePoint(int code) {
        ...
        if (ic != null) {
            ...
            if (ProductionFlag.IS_EXPERIMENTAL) {
                ResearchLogger.ime_sendKeyCodePoint(code);
            }
        }
    }
    ...
    public void onCodeInput(int primaryCode, int x, int y) {
        ...
        case Keyboard.CODE_DELETE:
            ...
            mShouldSwitchToLastSubtype = true;
            MyanmarImeLogger.logOnDelete(x, y);
            break;
    ...
    public void onTextInput(CharSequence text) {
        ...
        if (ProductionFlag.IS_EXPERIMENTAL) {
            ResearchLogger.ime_commitText(text);
        }
        ic.endBatchEdit();
        mKeyboardSwitcher.updateShiftState();
    ...
    private void handleBackspaceWhileInBatchEdit(final int spaceState, final InputConnection ic) {
        // In many cases, we may have to put the keyboard in auto-shift state agacom.
        mHandler.postUpdateShiftState();
        ...
        if (mEnteredText != null && sameAsTextBeforeCursor(ic, mEnteredText)) {
            ...
            if (ProductionFlag.IS_EXPERIMENTAL) {
                ResearchLogger.ime_deleteSurroundingText(length);
            }
        ...
        if (mWordComposer.isComposingWord()) {
            ...
            if (length > 0) {
                ...
                // SMM {
                if(mWordComposer.getUsedFixedWord()) {
                	ic.setComposingText(getTextWithUnderline(mWordComposer.getFixedWord()), 1); 
                } else {
                	ic.setComposingText(getTextWithUnderline(mWordComposer.getTypedWord()), 1);
                }
                // } SMM
            ...
            if (mLastSelectionStart != mLastSelectionEnd) {
                ...
                if (ProductionFlag.IS_EXPERIMENTAL) {
                    ResearchLogger.ime_deleteSurroundingText(lengthToDelete);
                }
            } else {
    ...
    private void handleCharacterWhileInBatchEdit(final int primaryCode,
        ...
        if (isComposingWord) {
            mWordComposer.add(primaryCode, x, y, mKeyboardSwitcher.getKeyboardView().getKeyDetector());
            if (ic != null) {
                ...
                // SMM {
                CharSequence composingText = mWordComposer.getTypedWord();
                if (mWordComposer.size() > 1) {
                	composingText = mWordComposer.setFixedWord(getWordCorrection(mWordComposer.getTypedWord()));
                } 
                // } SMM
                ic.setComposingText(getTextWithUnderline(composingText), 1);
            }
            mHandler.postUpdateSuggestions();
        } else {
    ...
    private void handleClose() {
        ...
        requestHideSelf(0);
        SoftKeyboardView inputView = mKeyboardSwitcher.getKeyboardView();
        if (inputView != null)
            inputView.closing();
    }
    ...
    public void switchToKeyboardView() {
        ...
        if (ProductionFlag.IS_EXPERIMENTAL) {
            ResearchLogger.ime_switchToKeyboardView();
        }
    ...
    private void commitCurrentAutoCorrection(final int separatorCodePoint,
        ...
        if (autoCorrection != null) {
        	...
        	final String typedWord = mWordComposer.getFixedWord(); // SMM
        	mWordComposer.setUsedFixedWord(true); // SMM
            ...
            if (ProductionFlag.IS_EXPERIMENTAL) {
                ResearchLogger.ime_commitCurrentAutoCorrection(typedWord,
                        autoCorrection.toString());
            }
            mExpectingUpdateSelection = true;
            commitChosenWord(autoCorrection, LastComposedWord.COMMIT_TYPE_DECIDED_WORD, separatorCodePoint);
            if (!typedWord.equals(autoCorrection) && null != ic) {
                // This will make the correction flash for a short while as a visual clue
                // to the user that auto-correction happened.
                ic.commitCorrection(new CorrectionInfo(mLastSelectionEnd - typedWord.length(), typedWord, autoCorrection));
            }
        }
    }
    ...
    public void pickSuggestionManuallyWhileInBatchEdit(final int index,
        ...
        if (suggestion.length() == 1 && isShowingPunctuationList()) {
            ...
            // So, MyanmarImeLogger logs "" as a user's input.
            MyanmarImeLogger.logOnManualSuggestion("", suggestion.toString(), index, suggestedWords);
            // Rely on onCodeInput to do the complicated swapping/stripping logic consistently.
            if (ProductionFlag.IS_EXPERIMENTAL) {
                ResearchLogger.ime_punctuationSuggestion(index, suggestion, x, y);
            }
        ...
        if (mInputAttributes.mApplicationSpecifiedCompletionOn
            ...
            if (ic != null) {
                ...
                if (ProductionFlag.IS_EXPERIMENTAL) {
                    ResearchLogger.ime_pickApplicationSpecifiedCompletion(index,
        ...
        MyanmarImeLogger.logOnManualSuggestion(replacedWord,
                suggestion.toString(), index, suggestedWords);
        if (ProductionFlag.IS_EXPERIMENTAL) {
            ResearchLogger.ime_pickSuggestionManually(replacedWord, index, suggestion, x, y);
        }
        mExpectingUpdateSelection = true;
        ...
        if (!showingAddToDictionaryHint) {
            // If we're not showing the "Touch again to save", then show corrections agacom.
            // In case the cursor position doesn't change, make sure we show the suggestions agacom.
        ...
        if (ic != null) {
            if (mSettingsValues.mEnableSuggestionSpanInsertion) {
                ...
                ic.commitText(SuggestionSpanUtils.getTextWithSuggestionSpan(
                        ...
                        1);
                if (ProductionFlag.IS_EXPERIMENTAL) {
                    ResearchLogger.ime_commitText(chosenWord);
                }
            } else {
    ...
    private void revertCommit(final InputConnection ic) {
        ...
        if (ProductionFlag.IS_EXPERIMENTAL) {
            ResearchLogger.ime_deleteSurroundingText(deleteLength);
        }
        ...
        if (0 == separatorLength || mLastComposedWord.didCommitTypedWord()) {
            ...
            Utils.Stats.onSeparator(mLastComposedWord.mSeparatorCode, WordComposer.NOT_A_COORDINATE,
                    WordComposer.NOT_A_COORDINATE);
            if (ProductionFlag.IS_EXPERIMENTAL) {
                ResearchLogger.ime_revertCommit(originallyTypedWord);
            }
    ...
    private boolean revertDoubleSpaceWhileInBatchEdit(final InputConnection ic) {
        ...
        ic.commitText("  ", 1);
        if (ProductionFlag.IS_EXPERIMENTAL) {
            ResearchLogger.ime_revertDoubleSpaceWhileInBatchEdit();
        }
        return true;
    }
    ...
    private static boolean revertSwapPunctuation(final InputConnection ic) {
        ...
        if (ProductionFlag.IS_EXPERIMENTAL) {
            ResearchLogger.ime_revertSwapPunctuation();
        }
        ic.endBatchEdit();
        return true;
    }
    ...
    // TODO: Remove this method from {@link MyanmarIME} and move {@link FeedbackManager} to
    ...
    private void launchSettingsClass(Class<? extends PreferenceActivity> settingsClass) {
        ...
        intent.setClass(MyanmarIME.this, settingsClass);
