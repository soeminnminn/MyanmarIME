...
import com.androidtweak.inputmethod.myanmar.SuggestedWords.SuggestedWordInfo;
...
public class Suggest implements Dictionary.WordCallback {
    ...
    // User history dictionary for the unigram map, internal to MyanmarIME
    public static final String DICT_KEY_USER_HISTORY_UNIGRAM = "history_unigram";
    // User history dictionary for the bigram map, internal to MyanmarIME
    public static final String DICT_KEY_USER_HISTORY_BIGRAM = "history_bigram";
    public static final String DICT_KEY_WHITELIST ="whitelist";

    private static final boolean DBG = MyanmarImeLogger.sDBG;
    ...
    public SuggestedWords getBigramPredictions(CharSequence prevWordForBigram) {
        MyanmarImeLogger.onStartSuggestion(prevWordForBigram);
        ...
        MyanmarImeLogger.onAddSuggestedWord("", Suggest.DIC_USER_TYPED, Dictionary.UNIGRAM);
        mConsideredWord = "";
    ...
    public SuggestedWords getSuggestedWords(
        ...
        final String consideredWord = mTrailingSingleQuotesCount > 0
                ...
                : typedWord;
        // Treating USER_TYPED as UNIGRAM suggestion for logging now.
        MyanmarImeLogger.onAddSuggestedWord(typedWord, Suggest.DIC_USER_TYPED, Dictionary.UNIGRAM);
    ...
    public boolean addWord(final char[] word, final int offset, final int length, int score,
        ...
        if (suggestions.size() > prefMaxSuggestions) {
            ...
            MyanmarImeLogger.onAddSuggestedWord(sb.toString(), dicTypeId, dataTypeForLog);
        }
        return true;
    }
