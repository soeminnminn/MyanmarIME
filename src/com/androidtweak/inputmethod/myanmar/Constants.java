...
public final class Constants {
    ...
    public static final class Subtype {
        ...
        public static final class ExtraValue {
             ...
             * This extra value is private to MyanmarIME.
             */
            public static final String KEYBOARD_LAYOUT_SET = "KeyboardLayoutSet";

            /**
             * The subtype extra value used to indicate that the subtype is additional subtype
             * that the user defined. This extra value is private to MyanmarIME.
             */
    ...
    public static class TextUtils {
        ...
        // SMM
        public static Typeface ZAWGYI_TYPEFACE;
        public static Typeface MM3_TYPEFACE;
        ...
        public static Typeface getTypeFace(Context context, String fontName) {
        	...
        	if (fontName.equals("Zawgyi-one")) {
        		return getZawGyiTypeFace(context);
        	} else if (fontName.equals("Myanmar3")) {
        		return getMyanmarTypeFace(context);
        	} else {
        ...
        public static Typeface getMyanmarTypeFace(Context context) {
    		if(MM3_TYPEFACE == null) {
    			if(context == null) return Typeface.DEFAULT; 
    			MM3_TYPEFACE = Typeface.createFromAsset(context.getAssets(), "fonts/mm3.ttf");
    		}
