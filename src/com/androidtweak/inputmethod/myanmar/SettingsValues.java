...
public class SettingsValues {
    ...
    public SettingsValues(final SharedPreferences prefs, final Context context) {
        ...
        // SMM {
        mJellyBeanFix = prefs.getBoolean(Settings.PREF_JELLYBEAN_FIX, 
        		res.getBoolean(R.bool.config_default_jellybean_fix));;
        mUsedUnicode = prefs.getBoolean(Settings.PREF_USED_UNICODE, 
        		res.getBoolean(R.bool.config_default_used_unicode));;
    	// } SMM 
    }
