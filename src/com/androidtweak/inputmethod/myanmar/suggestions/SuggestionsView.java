...
package com.androidtweak.inputmethod.myanmar.suggestions;
...
import com.androidtweak.inputmethod.myanmar.Suggest;
import com.androidtweak.inputmethod.myanmar.SuggestedWords;
...
import com.androidtweak.inputmethod.keyboard.MoreKeysPanel;
import com.androidtweak.inputmethod.keyboard.PointerTracker;
import com.androidtweak.inputmethod.keyboard.ViewLayoutUtils;
...
public class SuggestionsView extends RelativeLayout implements OnClickListener,
    ...
    static final boolean DBG = MyanmarImeLogger.sDBG;
    ...
    private static class SuggestionsViewParams {
        ...
        private int getSuggestionTextColor(int index, SuggestedWords suggestedWords, int pos) {
            ...
            if (MyanmarImeLogger.sDBG && suggestedWords.size() > 1) {
        ...
        public void layout(SuggestedWords suggestedWords, ViewGroup stripView, ViewGroup placer,
            ...
            for (int index = 0; index < countInStrip; index++) {
                ...
                // SMM {
                if (MyanmarImeUtils.isMyChar(text)) {
                	word.setTypeface(Constants.TextUtils.getZawGyiTypeFace(word.getContext()));
                	word.setText(MyanmarImeUtils.ZawGyiDrawFix(text));
                } else {
                	word.setText(text);
                }
                // } SMM
                // word.setText(text); // TextView.setText() resets text scale x to 1.0. // SMM
        ...
        public void layoutAddToDictionaryHint(CharSequence word, ViewGroup stripView,
            ...
            // SMM {
            if (MyanmarImeUtils.isMyChar(text)) {
            	wordView.setTypeface(Constants.TextUtils.getZawGyiTypeFace(wordView.getContext()));
            	wordView.setText(MyanmarImeUtils.ZawGyiDrawFix(text));
            } else {
        ...
        private static Typeface getTextTypeface(CharSequence text) {
        	if (MyanmarImeUtils.isMyChar(text)) { // SMM
        		return Constants.TextUtils.getZawGyiTypeFace(null);
        	}
