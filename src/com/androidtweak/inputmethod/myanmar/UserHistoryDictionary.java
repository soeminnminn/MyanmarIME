...
import com.androidtweak.inputmethod.myanmar.UserHistoryForgettingCurveUtils.ForgettingCurveParams;
...
public class UserHistoryDictionary extends ExpandableDictionary {
    ...
    public static final boolean PROFILE_SAVE_RESTORE = MyanmarImeLogger.sDBG;
    ...
    private static Cursor query(String selection, String[] selectionArgs) {
        ...
        // main INNER JOIN frequency ON (macom._id=freq.pair_id)
