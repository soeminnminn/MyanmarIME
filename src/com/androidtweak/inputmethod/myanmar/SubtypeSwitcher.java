...
import static com.androidtweak.inputmethod.myanmar.Constants.Subtype.ExtraValue.REQ_NETWORK_CONNECTIVITY;
...
public class SubtypeSwitcher {
    private static boolean DBG = MyanmarImeLogger.sDBG;
    private static final String TAG = SubtypeSwitcher.class.getSimpleName();

    private static final SubtypeSwitcher sInstance = new SubtypeSwitcher();
    private /* final */ MyanmarIME mService;
    ...
    // Note: This variable is always non-null after {@link #initialize(MyanmarIME)}.
    ...
    public static void init(MyanmarIME service) {
    ...
    private void initialize(MyanmarIME service) {
        mService = service;
    ...
    // Update parameters which are changed outside MyanmarIME. This parameters affect UI so they
    ...
    // Update the current subtype. MyanmarIME.onCurrentInputMethodSubtypeChanged calls this function.
